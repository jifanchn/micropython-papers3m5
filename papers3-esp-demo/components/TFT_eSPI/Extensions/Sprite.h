...
class TFT_eSprite : public TFT_eSPI {
 ...
 public:
  ...
  void*    createSprite(int16_t width, int16_t height, uint8_t frames, uint8_t* buffer);
  ...
  virtual bool     pushSprite(int32_t tx, int32_t ty, int32_t sx, int32_t sy, int32_t sw, int32_t sh);
