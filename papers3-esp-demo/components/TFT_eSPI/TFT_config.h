...
// General pins
#if CONFIG_TFT_CS == -1
    #warning "Invalid Chip Select pin. Check TFT_eSPI configuration"
#else
    #define TFT_CS          CONFIG_TFT_CS
#endif

#if CONFIG_TFT_DC == -1
    #warning "Invalid Data/Command pin. Check TFT_eSPI configuration"
#else
...
// Backlight config
    ...
    #if CONFIG_TFT_BL == -1
        #warning "Invalid backlight control pin. Check TFT_eSPI configuration"
    #else
...
// 8 BIT PARALLEL BUS
    ...
    #if CONFIG_TFT_D0 == -1
        #warning "Invalid Data 0 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D0      CONFIG_TFT_D0
    #endif

    #if CONFIG_TFT_D1 == -1
        #warning "Invalid Data 1 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D1      CONFIG_TFT_D1
    #endif

    #if CONFIG_TFT_D2 == -1
        #warning "Invalid Data 2 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D2      CONFIG_TFT_D2
    #endif

    #if CONFIG_TFT_D3 == -1
        #warning "Invalid Data 3 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D3      CONFIG_TFT_D3
    #endif

    #if CONFIG_TFT_D4 == -1
        #warning "Invalid Data 4 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D4      CONFIG_TFT_D4
    #endif

    #if CONFIG_TFT_D5 == -1
        #warning "Invalid Data 5 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D5      CONFIG_TFT_D5
    #endif

    #if CONFIG_TFT_D6 == -1
        #warning "Invalid Data 6 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D6      CONFIG_TFT_D6
    #endif

    #if CONFIG_TFT_D7 == -1
        #warning "Invalid Data 7 pin. Check TFT_eSPI configuration"
    #else
        #define TFT_D7      CONFIG_TFT_D7
    #endif
    
    #if CONFIG_TFT_WR == -1
        #warning "Invalid Write strobe pin. Check TFT_eSPI configuration"
    #else
        #define TFT_WR      CONFIG_TFT_WR
    #endif

    #if CONFIG_TFT_RD == -1
        #warning "Invalid Read strobe pin. Check TFT_eSPI configuration"
    #else
...
// SPI BUS
        ...
        #warning "Invalid MOSI pin. Check TFT_eSPI configuration"
    #else
        #define TFT_MOSI      CONFIG_TFT_MOSI
    #endif

    #if CONFIG_TFT_SCLK == -1
        #warning "Invalid Clock pin. Check TFT_eSPI configuration"
    #else
...
***************************************************************************************/
        ...
        #warning "Invalid Touch Chip Select pin. Check TFT_eSPI configuration"
    #else
